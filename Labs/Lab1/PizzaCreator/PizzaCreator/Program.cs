...
namespace PizzaCreator
{
    class Program
    {
         ...
         * If user enters wrong input program asks to enter again and loop until user enters a valid input.
         * Then go to the next action as user requested.
         * Also, program runs until the user enter 4 for exit.
         */
        static void Main( string[] args )
        {
            ...
            do
            {
                ...
                {
                    case 1:
                    NewOrder(meatArray, vegiesArray, pizzaSize, pizzaMeats, pizzaVegies, pizzaSauce, pizzaCheese, pizzaDelivery, pizzaTotal, sizePrice, saucePrice, meatPrice, vegiesPrice, deliveryPrice, cheesePrice, showSize, showMeat, showVegies, showSauce, showCheese, showDelivery);
                    break;
                    case 2:
                    ModifyOrder(meatArray, vegiesArray, pizzaSize, pizzaMeats, pizzaVegies, pizzaSauce, pizzaCheese, pizzaDelivery, pizzaTotal, sizePrice, saucePrice, meatPrice, vegiesPrice, deliveryPrice, cheesePrice, showSize, showMeat, showVegies, showSauce, showCheese, showDelivery);
                    break;
                    case 3:
        ...
        /// <summary>
        /// New Order choice. When user enter 1 program goes to this method. In here program get the order information from the user and then calls displayOrder() method to deply the information.
        /// If user enter an invalid input program will ask to enter again until user inputs a valid number.
        /// </summary>
        public static void NewOrder( int[] meatArray, int[] vegiesArray, int pizzaSize, int pizzaMeats, int pizzaVegies, int pizzaSauce, int pizzaCheese, int pizzaDelivery, double pizzaTotal, double sizePrice, double saucePrice, double meatPrice, double vegiesPrice, double deliveryPrice, double cheesePrice, string showSize, string showMeat, string showVegies, string showSauce, string showCheese, string showDelivery )
        {
            ...
            while (pizzaMeats != 0)
            {
                ...
                meatArray[i] = pizzaMeats;
                Console.WriteLine(meatArray[i]);
                i++;
            }
            ...
            Console.WriteLine("You have selected {0} and your total for now is {1:C}.", showMeat, pizzaTotal);
            ...
            Console.WriteLine("You have selected {0} and your total for now is {1:C}.", pizzaVegies, pizzaTotal);
        ...
        /// <summary>
        /// This method modifys the existing order. if there is no an existing order program shows an error message.
        /// </summary>
        public static void ModifyOrder( int[] meatArray, int[] vegiesArray, int pizzaSize, int pizzaMeats, int pizzaVegies, int pizzaSauce, int pizzaCheese, int pizzaDelivery, double pizzaTotal, double sizePrice, double saucePrice, double meatPrice, double vegiesPrice, double deliveryPrice, double cheesePrice, string showSize, string showMeat, string showVegies, string showSauce, string showCheese, string showDelivery )
        {
            if (pizzaSize == 0)
            {
        ...
        /// <summary>
        /// Will display all the order information with prices. Then the total.
        /// this method will not show all the meats and vegies if the user enters more than one. But will calculate the price correctly and shows.
        /// </summary>
